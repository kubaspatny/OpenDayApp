...
/**
 * AbstractBusinessObject class is the base class for all the business objects in this application.
 * It only contains the ID attribute for database mapping as a primary key.
 */
@MappedSuperclass
